...
path = ['../../../../shanghaitech/part_' dataset '_final/images/'];
gt_path = ['../../../../shanghaitech/part_' dataset '_final/ground_truth/'];
gt_path_csv = ['../../../../shanghaitech/part_' dataset '_final/ground_truth_csv/'];
